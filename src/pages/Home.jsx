    ...
    <>
      <div className="relative">
        <div className="px-10 md:px-20 flex mt-20 flex-col md:flex-row relative">
          {/* Left-side */}
          <div className="w-full md:w-5/5 flex flex-col gap-9 z-10 md:p-8">
          ...
          <div className="w-full md:w-2/3 md:ml-40 md:mt-[-100px]">
            <img src={img} alt="" className="w-full mx-auto md:w-full" />
          </div>
        </div>
      </div>
      ...
      <div className="mt-4 pl-25">
        <h4 className="text-lg font-medium text-center text-blue-400 italic md:text-xl">
